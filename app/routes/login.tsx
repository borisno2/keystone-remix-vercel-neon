...
function validateUrl(url: string) {
	let urls = ['/users', '/', 'https://remix.run']
...
export const action = async ({ request }: ActionArgs) => {
	...
	const redirectTo = validateUrl((form.get('redirectTo') as string) || '/tasks')
	if (
	...
	switch (loginType) {
		case 'login': {
			...
			// if there is a user, create their session and redirect to /tasks
		...
		case 'register': {
			...
			// create their session and redirect to /tasks
			return createUserSession(user.id, redirectTo)
		}
		default: {
			return badRequest({
